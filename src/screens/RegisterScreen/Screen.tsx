    ...
    <FormProvider {...form}>
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <Button
            mode="contained"
            onPress={handleSubmit(({ confirm_password: _, ...data }) => mutation.mutate(data))}
            style={styles.submit}
            disabled={mutation.isLoading}
          ...
          <View style={styles.footer}>
            <Text variant="labelLarge">Sudah Memiliki Akun ? </Text>
            <Pressable onPress={() => navigate('LoginScreen')} disabled={mutation.isLoading}>
